...
namespace SysEnvVars
{
    ...
    {
        // add [o] <env-name> [o] <val_1 ... val_n>
        static Exec get_exec_add(Args e)
        {
            ...
            return _ => 
            {
                ...
                {
#if NetCore
                    EnvVarsHelper.AddVars(envs, (env_name, values));
#else 
                    EnvVarsHelper.AddVars(envs, ValueTuple.Create<string, IEnumerable<string>>(env_name, values));
#endif
                }
